		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-3">
					...
					<div class="col-md-12  single-item noPadding">
						<div class="top"><img src="images/products/picture3.jpg"></div>
						<div class="bottom">
							<h3 class="item-title"><a href="product.php">Beautiful Watch</a></h3>
							<div class="pull-right cutted-price text-muted"><del>$ 500/=</del></div>
							<div class="clearfix"></div>
					...
					<div class="col-md-12  single-item noPadding">
						<div class="top"><img src="images/products/picture2.jpg"></div>
						<div class="bottom">
							<h3 class="item-title"><a href="product.php">Beautiful Watch</a></h3>
							<div class="pull-right cutted-price text-muted"><del>$ 500/=</del></div>
							<div class="clearfix"></div>
					...
					<div class="col-md-12  single-item noPadding">
						<div class="top"><img src="images/products/picture1.jpg"></div>
						<div class="bottom">
							<h3 class="item-title"><a href="product.php">Beautiful Watch</a></h3>
							<div class="pull-right cutted-price text-muted"><del>$ 500/=</del></div>
							<div class="clearfix"></div>
